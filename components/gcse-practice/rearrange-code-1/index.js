...
const MarkUp = ({email,  pupilProgress}) => (<motion.div variants={ContainerVariant} initial="hidden" animate="show">
                ...
                <Section >
                    <SectionTitle >Rearrange Code Questions 1</SectionTitle>
                    <SectionText>
                ...
                <Activity repl="https://replit.com/@mrsalih/rearrange-code-1" 
                          email={email} 
                          challengeName="gcse-practice::rearrange-code-1" 

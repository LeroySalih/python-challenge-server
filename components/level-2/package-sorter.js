...
`}>
    ...
    <Activity title="Package Sorter" 
        repl="https://replit.com/@mrsalih/package-sorter-1#main.py" 
        email={email} 
        challengeName="level-2::package-sorter-1" 
        pupilProgress={pupilProgress}
        />


<Activity title="Package Sorter" 
        repl="https://replit.com/@mrsalih/package-sorter-2#main.py" 
        email={email} 
...
<Activity title="Package Sorter" 
        repl="https://replit.com/@mrsalih/package-sorter-3#main.py" 
        email={email} 

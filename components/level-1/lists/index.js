...
`}/>
    ...
    <Section>
        ...
        <Section>
            <SectionTitle>Lists 1 - Declaring</SectionTitle>
            <Activity repl="https://replit.com/@mrsalih/lists-1#challenge.md" 
                            email={email} 
                            challengeName="level-1::lists-1" 
                            pupilProgress={pupilProgress}
                            />
        </Section>
        <Section>
            <SectionTitle>Lists 2 - Accessing</SectionTitle>
            <Activity repl="https://replit.com/@mrsalih/lists-2#challenge.md" 
                            email={email} 
                            challengeName="level-1::lists-2" 
                            pupilProgress={pupilProgress}
                            />
        </Section>
        <Section>
            <SectionTitle>Lists 3 - Appending</SectionTitle>
            <Activity repl="https://replit.com/@mrsalih/lists-3#challenge.md" 
                            email={email} 
                            challengeName="level-1::lists-3" 
                            pupilProgress={pupilProgress}
                            />
        </Section>
        <Section>
            <SectionTitle>Lists 4 - Removing</SectionTitle>
            <Activity repl="https://replit.com/@mrsalih/lists-4#challenge.md" 
                            email={email} 
                            challengeName="level-1::lists-4" 
                            pupilProgress={pupilProgress}
                            />
        </Section>
        <Section>
            <SectionTitle>Lists 5 - Looping</SectionTitle>
            <Activity repl="https://replit.com/@mrsalih/lists-5#challenge.md" 
                            email={email} 
                            challengeName="level-1::lists-5" 
                            pupilProgress={pupilProgress}
                            />
        </Section>
